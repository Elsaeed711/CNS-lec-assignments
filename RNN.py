...
if __name__ == "__main__":
    ...
    train_inputs = [one_hot(word2idx[w], vocab_size) for w in vocab[:-1]]
    train_targets = [one_hot(word2idx[w], vocab_size) for w in vocab[1:]]

    model = WordPredictorRNN(input_size=vocab_size, hidden_size=8, output_size=vocab_size, learning_rate=0.01)

    print("\nTraining RNN to predict next word...\n")
