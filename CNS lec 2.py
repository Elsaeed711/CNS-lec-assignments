...
delta_h1 = delta_o1 * w5 * (1 - h1 ** 2) + delta_o2 * w6 * (1 - h1 ** 2)
delta_h2 = delta_o1 * w7 * (1 - h2 ** 2) + delta_o2 * w8 * (1 - h2 ** 2)

grad_w1 = delta_h1 * i1 * (1 - h1 ** 2)
grad_w2 = delta_h2 * i1 * (1 - h2 ** 2)
grad_w3 = delta_h1 * i2 * (1 - h1 ** 2)
grad_w4 = delta_h2 * i2 * (1 - h2 ** 2)
grad_w5 = delta_o1 * h1 * (1 - o1 ** 2)
grad_w6 = delta_o1 * h2 * (1 - o2 ** 2)
grad_w7 = delta_o2 * h1 * (1 - o1 ** 2)
grad_w8 = delta_o2 * h2 * (1 - o2 ** 2)

grad_b1 = delta_h1 * (1 - h1 ** 2) + delta_h2 * (1 - h2 ** 2)
